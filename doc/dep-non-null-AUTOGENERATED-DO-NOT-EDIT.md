...
-   [Dart issue \#22](https://code.google.com/p/dart/issues/detail?id=22), starred by 197 individuals, is a request for *support for non-nullable types*.
